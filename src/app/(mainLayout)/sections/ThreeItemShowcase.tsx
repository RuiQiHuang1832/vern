...
export default function ThreeItemShowcase() {
  return (
    ...
    <div style={{}}>
      <div  className={` text-center mx-auto col-md-10 col pb-5`}>
        ...
        <p className="fs-5 text-secondary">We prioritize delivering a streamlined, high-quality workflow designed for efficiency and ease of use. <br></br>Additionally, we offer robust features to enhance your review experience..</p>
      </div>
        ...
        <div className={`${styles["tool-grid"]}  mx-auto`}>
          {toolData.map((data, i) => (
            <div key={i} className={`${styles["grid-item"]} pb-5 item item-${i}`}>
                <Image priority src={data.source.src} alt={data.title} width={0} height={0} sizes="100vw" style={{ height: "auto", width:"80%"}}  quality={100}></Image>
