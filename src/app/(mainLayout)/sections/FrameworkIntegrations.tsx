...
export default function FrameworkIntegrations() {
  return (
    ...
    <IntroSection header="Framework Integration" title='compatible with modern technologies' description={<>Built to integrate seamlessly with the frameworks <br className="d-none d-xl-block"></br> and tools  you already know and love.</>}></IntroSection>
      <div className={`${styles["logo-scroll-container"]} mx-auto col-10`}>
      ...
      <div className={`d-flex  flex-lg-row flex-column mx-auto ${styles["creative-process-container"]} my-5 align-items-center col-10`}>

        <div style={{ flex: "1 0 auto" }} className="d-flex flex-column col-lg-3 col align-items-center ">
          {featuresData.map((e, i) => (
            <div key={i} style={{maxWidth:"400px"}} className={`my-3`}>
