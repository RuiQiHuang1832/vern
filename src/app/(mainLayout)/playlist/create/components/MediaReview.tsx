              ...
              <div className={`d-flex mt-5 ${styles["review-container"]} justify-content-sm-between justify-content-start ${containerClassName}`}>
                <div className={`${styles["poster-container"]} col-xl-3 col-lg-4 col text-center`}>
                  ...
                  <div className="d-flex flex-column text-primary">
                    ...
                    <LiaCaretDownSolid  key={title.id} onClick={(e: React.MouseEvent) => toggleReviewDropdown(e, title.id)} className={`${classNames(styles["dropdown-review-arrow"], { [styles["rotate"]]: isReviewOpen[title.id] })} d-block d-md-none mx-auto`} color="white" size="2.5em"></LiaCaretDownSolid>
                  </div>
                </div>
                <div className={`p-5 ms-3 position-relative col-xl-9 col-lg-8 col-7 d-md-block d-none`}>
                  ...
                  <LiaCaretDownSolid key={title.id} onClick={(e: React.MouseEvent) => toggleReviewDropdown(e, title.id)} className={`${classNames(styles["dropdown-review-arrow"], { [styles["rotate"]]: isReviewOpen[title.id] })}`} color="white" size="2.5rem"></LiaCaretDownSolid>
                </div>
              </div>
